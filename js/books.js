  ...
  const LEVELS = [
    ...
    },
    {
      ...
      books: withColors([
        ...
        dew("Fun Card Games", "Ray Hoyle", "795", "HOY"),
        fic("Matilda", "Roald Dahl", "DAH"),
    ...
    },
    {
      ...
      books: withColors([
        ...
        dew("Reptiles Up Close", "Leo Vance", "597.9", "VAN"),
    ...
    },
    {
      ...
      preplaced: [0, 4, 8],
      books: withColors([
        dew("Exploring Mars", "Iris Zimmer", "523.43", "ZIM"),
        dew("Journey to Jupiter", "Cara Bradley", "523.45", "BRA"),
        dew("Whales of the Deep", "Anna Reed", "599.5", "REE"),
        dew("Wild Wolves", "Mia Marsh", "599.77", "MAR"),
